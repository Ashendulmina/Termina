#!/usr/bin/python
#155
#ASCII Text Art Generated By : https://fsymbols.com/
#This Peace Of Code Is Opened For Editing And Moddification By Individuval Users
#No need to credit me for that
#I would love to see what you have made 
#post your moddifications at Ashen#8481 on discord
...
def server(IP,PORT,senrev=senrev):
  ...
  try:
    ...
    control()
         ...
         exit(1)
if len(sys.argv) !=3:
        print("Error! : No Syntax Found")
        print("2 Input Syntax Required 0 Found")
        print("Tool Usage: python server.py <IP> <PORT>")
        print("")
        print("▀█▀ █▀▀ █▀█ █▀▄▀█ █ █▄ █ ▄▀█   █▀ █▀▀ █▀█ █ █ █▀▀ █▀█   █▀▀ █▀█ █▀█ █▀█ █▀█")
        print(" █  ██▄ █▀▄ █ ▀ █ █ █ ▀█ █▀█   ▄█ ██▄ █▀▄ ▀▄▀ ██▄ █▀▄   ██▄ █▀▄ █▀▄ █▄█ █▀▄")
        exit(1)
